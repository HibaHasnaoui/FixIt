...
namespace DisponibiliteBundle\Tests\Controller;
...
class DisponibiliteControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $this->assertEquals(200, $client->getResponse()->getStatusCode(), "Unexpected HTTP status code for GET /disponibilite/");
